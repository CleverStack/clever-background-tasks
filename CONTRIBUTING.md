...
1. [GitHub Issues](https://github.com/CleverStack/clever-background-tasks/issues)
...
4. Please follow the [coding guidelines](https://github.com/CleverStack/clever-background-tasks/blob/master/.jshintrc)
5. Push your changes and submit a [pull request](https://github.com/CleverStack/clever-background-tasks/compare/) to the master branch.